...
- [x] G25: Every gate names the requirement it proves, and every requirement has a gate.
  ...
  EXPECT: PASS: 25 gates cover 14 requirement(s), 8 of them started; 7 planned and not yet gated
  EVIDENCE: PASS: 25 gates cover 14 requirement(s), 8 of them started; 7 planned and not yet gated
